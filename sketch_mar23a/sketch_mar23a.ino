...
void autoTune()
{
  ...
  tempLevel = map(tempLevel, low+30, high-30, 0, 255);
  tempLevel = constrain(tempLevel, 0, 255);
...
void frequencyTune(){
  lightLevel = map(lightLevel, 0, 1023, 1000, 10000);
  lightLevel = constrain(lightLevel, 1000, 10000);
